...
type Tab = "details" | "update" | "password";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 space-y-1 lg:space-y-2">
            ...
            <div className="opacity-50 pointer-events-none">
              <button
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-[#3A3A3A] dark:text-gray-300"
                disabled
              >
                <div className="flex flex-col">
          ...
          {/* Main content – render selected tab */}
